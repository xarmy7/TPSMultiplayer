...
void AEnemySpawnerButton::Activate(ETeam team)
{
	...
	GetWorld()->GetTimerManager().SetTimer(mSpawnTimerHandle, this, &AEnemySpawnerButton::SpawnOnServer, SecondPerSpawn, true);
...
void AEnemySpawnerButton::SpawnOnServer_Implementation()
{
