...
void AUndeadCharacter::PunchOnServer_Implementation()
{
	PunchMulticast();
}

void AUndeadCharacter::PunchMulticast_Implementation()
{
...
void AUndeadCharacter::StartDisappearMulticast_Implementation()
{
